...
std::unique_ptr<facebook::react::JSExecutor> JSWasmExecutorFactory::createJSExecutor(
  ...
  return std::make_unique<facebook::react::JSIExecutor>(
    std::make_unique<Runtime>(), delegate, facebook::react::JSIExecutor::defaultTimeoutInvoker, nullptr);
}
...
// void JSWasmExecutor::setGlobalVariable(const char *name, const char *value) {
//   ReactNativeWasm::JavascriptAccessor::setGlobalVariable(name, value);
// }

// void *JSWasmExecutor::getJavaScriptContext() {
//   std::cout << "getJavaScriptContext called" << std::endl;
