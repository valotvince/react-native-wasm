...
namespace ReactNativeWasm {
    ...
    void JSWasmExecutor::initializeRuntime() {
        ...
        setGlobalVariable(
            ...
            std::make_unique<facebook::react::JSBigStdString>(folly::toJson(config)));
    }

    /**
     * Execute an application script bundle in the JS context.
     */
    void JSWasmExecutor::loadBundle(
     ...
     */
    void JSWasmExecutor::setBundleRegistry(
     ...
     */
    void JSWasmExecutor::registerBundle(
        uint32_t bundleId,
     ...
     */
    void JSWasmExecutor::invokeCallback(
     ...
     */
    std::string JSWasmExecutor::getDescription() {
        return "JSWasmExecutor";
    }

    std::string JSWasmExecutor::getSyntheticBundlePath(
        uint32_t bundleId,
        const std::string &bundlePath) {
            return "toto";
        }
