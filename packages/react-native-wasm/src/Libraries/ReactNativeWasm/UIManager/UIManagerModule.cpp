...
auto UIManagerModule::getName() -> std::string { return UIManagerModule::Name; }

auto UIManagerModule::getConstants() -> std::map<std::string, folly::dynamic> { return {}; }
...
auto UIManagerModule::getMethods() -> std::vector<Method> {
  return {
    ...
    Method(
      "measure",
      [this](folly::dynamic args, Callback callback) { auto reactTag = facebook::xplat::jsArgAsInt(args, 0); }),
    Method(
      "measureInWindow",
      [this](folly::dynamic args, Callback callback) { auto reactTag = facebook::xplat::jsArgAsInt(args, 0); }),
    Method(
