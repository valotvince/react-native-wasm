...
public:
  ...
  void uiManagerDidConfigureNextLayoutAnimation(
    facebook::jsi::Runtime &runtime, facebook::react::RawValue const &config,
    facebook::jsi::Value const &successCallback, facebook::jsi::Value const &failureCallback) const;
   ...
   */
  void
  setComponentDescriptorRegistry(const facebook::react::SharedComponentDescriptorRegistry &componentDescriptorRegistry);
