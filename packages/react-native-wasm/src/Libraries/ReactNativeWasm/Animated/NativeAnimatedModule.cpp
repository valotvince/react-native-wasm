...
auto NativeAnimatedModule::getMethods() -> std::vector<Method> {
  return {
    Method(
      "startOperationBatch",
      [](folly::dynamic /*args*/) { std::cout << "NativeAnimatedModule::startOperationBatch" << std::endl; }),

    Method(
      "finishOperationBatch",
      [](folly::dynamic /*args*/) { std::cout << "NativeAnimatedModule::finishOperationBatch" << std::endl; }),
    Method(
      "createAnimatedNode",
